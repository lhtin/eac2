...
set(CONAN_NLOHMANN_JSON_ROOT "/Users/lhtin/.conan/data/nlohmann_json/3.7.3/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_NLOHMANN_JSON "/Users/lhtin/.conan/data/nlohmann_json/3.7.3/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
...
set(CONAN_BUILD_DIRS_NLOHMANN_JSON "/Users/lhtin/.conan/data/nlohmann_json/3.7.3/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_NLOHMANN_JSON "${CONAN_FRAMEWORKS_NLOHMANN_JSON}")
...
set(CONAN_LIBS_FRAMEWORKS_NLOHMANN_JSON ${CONAN_PKG_LIBS_NLOHMANN_JSON} ${CONAN_FRAMEWORKS_FOUND_NLOHMANN_JSON})
...
set(CONAN_INCLUDE_DIRS "/Users/lhtin/.conan/data/nlohmann_json/3.7.3/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include" ${CONAN_INCLUDE_DIRS})
...
set(CONAN_CMAKE_MODULE_PATH "/Users/lhtin/.conan/data/nlohmann_json/3.7.3/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_NLOHMANN_JSON}" "${CONAN_LIB_DIRS_NLOHMANN_JSON}"
                                  CONAN_PACKAGE_TARGETS_NLOHMANN_JSON "${CONAN_SYSTEM_LIBS_NLOHMANN_JSON} "
                                  "" nlohmann_json)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_NLOHMANN_JSON_DEBUG}" "${CONAN_LIB_DIRS_NLOHMANN_JSON_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_NLOHMANN_JSON_DEBUG "${CONAN_SYSTEM_LIBS_NLOHMANN_JSON_DEBUG} "
                                  "debug" nlohmann_json)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_NLOHMANN_JSON_RELEASE}" "${CONAN_LIB_DIRS_NLOHMANN_JSON_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_NLOHMANN_JSON_RELEASE "${CONAN_SYSTEM_LIBS_NLOHMANN_JSON_RELEASE} "
                                  "release" nlohmann_json)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_NLOHMANN_JSON_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_NLOHMANN_JSON_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_NLOHMANN_JSON_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_NLOHMANN_JSON_RELWITHDEBINFO} "
                                  "relwithdebinfo" nlohmann_json)
    conan_package_library_targets("${CONAN_LIBS_FRAMEWORKS_NLOHMANN_JSON_MINSIZEREL}" "${CONAN_LIB_DIRS_NLOHMANN_JSON_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_NLOHMANN_JSON_MINSIZEREL "${CONAN_SYSTEM_LIBS_NLOHMANN_JSON_MINSIZEREL} "
